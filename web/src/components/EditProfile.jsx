...
const EditProfile = ({ task, handleEditing }) => {
    ...
    return (
        <main className="flex flex-col justify-center items-center w-full">
            ...
            <form className="w-full flex flex-col justify-center items-center border-2 border-blue-950 rounded-lg p-3 mt-7 mb-8">
                {message && (
                ...
                <div className='flex'>
                    ...
                    <div className='w-56 bg-sky-300 rounded-lg p-1 mt-4 text-center hover:bg-blue-950 hover:text-white hover:shadow hover:shadow-blue-950'>
